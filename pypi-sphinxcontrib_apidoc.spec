...
Version  : 0.6.0
Release  : 45
URL      : https://files.pythonhosted.org/packages/1c/8d/161842a1c199c1baed5f5bc0765a59a791324f962fea3b604f105c9493e7/sphinxcontrib_apidoc-0.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/1c/8d/161842a1c199c1baed5f5bc0765a59a791324f962fea3b604f105c9493e7/sphinxcontrib_apidoc-0.6.0.tar.gz
...
%prep
%setup -q -n sphinxcontrib_apidoc-0.6.0
cd %{_builddir}/sphinxcontrib_apidoc-0.6.0
pushd ..
cp -a sphinxcontrib_apidoc-0.6.0 buildavx2
popd
pushd ..
cp -a sphinxcontrib_apidoc-0.6.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746713493
...
cp %{_builddir}/sphinxcontrib_apidoc-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_apidoc/f46de5f58d55a3c4dff150b3a055d90c2458b44e || :
